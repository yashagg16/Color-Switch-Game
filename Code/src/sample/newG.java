...
//                obstacleOnScreen.setLayoutY(obstacleOnScreen.getLayoutY()+5);
//                nextObstacle.setLayoutY(nextObstacle.getLayoutY()+5);
...
//                        System.out.println("obstacle on screen " + obstacleOnTop.getClass().toString());
//                        System.out.println("obstacle to come " + obstacleToCome.getClass().toString());
//                        getNewObstacle();
//                        System.out.println("later obstacle on screen " + obstacleOnTop.getClass().toString() + " " + obstacleOnTop.finalObstacle.getLayoutY());
//                        System.out.println("later obstacle to come " + obstacleToCome.getClass().toString() + " " + obstacleToCome.finalObstacle.getLayoutY());
//
